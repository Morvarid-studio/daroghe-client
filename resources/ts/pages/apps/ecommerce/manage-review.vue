...
// Fetch Reviews
const { data: ReviewData, execute: fetchReviews } = await useApi<any>(
  createUrl('/apps/ecommerce/reviews', {
    query: {
      q: searchQuery,
...
<template>
  <VRow class="match-height">
    ...
    <VCol cols="12">
      <VCard>
        <VCardText>
          <div class="d-flex justify-space-between flex-column flex-md-row gap-6">
            <div>
              <AppTextField
                v-model="searchQuery"
